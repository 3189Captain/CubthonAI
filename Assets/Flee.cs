...
public class Flee : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        transform.rotation = Quaternion.LookRotation(-diffVector.normalized); //point away from player
        rb.AddForce(diffVector.normalized * speedMult, ForceMode.VelocityChange); //move away from player
    }
}
